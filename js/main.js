...
document.addEventListener("DOMContentLoaded", () => {
            ...
            const todayMaxTempSummaryPlusThree = dailyData.temperature_2m_max[3]+ "&deg;C";

            const todayMaxTempSummaryPlusFour = dailyData.temperature_2m_max[4]+ "&deg;C";

            const todayMaxTempSummaryPlusFive = dailyData.temperature_2m_max[5]+ "&deg;C";
            ...
            const todayMaxWind = dailyData.wind_speed_10m_max[0] + "KM/H";
              ...
              const main = document.querySelector('main');
                    dataStore.list().forEach((forecastCard) => { 
                    main.innerHTML = main.innerHTML + createForecastCardItem(forecastCard);
                    });
                ...
                const summaryForecastCards = [
                    ...
                    },
                    {
                      ...
                      },
                      {
                        ...
                        summaryForecastCards.forEach((summaryForecastCard) => footer.innerHTML += createSummaryForecastCardItem(summaryForecastCard));
